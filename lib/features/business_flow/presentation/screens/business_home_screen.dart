                          ...
                          _buildFooterButton(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  // IDを渡して画面を開く
                                  builder: (context) => BusinessReviewManagementScreen(adminId: uid),
                                ),
                              );
                            },
                          ),
  ...
  Widget _buildMainButton({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.1), spreadRadius: 1, blurRadius: 8, offset: const Offset(0, 4))],
      ),
